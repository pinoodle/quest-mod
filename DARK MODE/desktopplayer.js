...
/////////////////////////////////////////////////////////////////////////////////////////////////
var naughtyFix = function() {
  setTimeout(function(){

    document.getElementById("gameBorder").style.backgroundColor = "#222";
    document.body.style.backgroundColor = "#000";
    document.getElementById("txtCommand").style.backgroundColor = "#222";
    document.getElementById("txtCommand").style.color = "#EEE";
    document.getElementById("gridPanel").style.backgroundColor = "#444";
    document.getElementById("gridPanel").style.borderRadius = "16px";

    var spans = document.getElementsByTagName("SPAN");
    var lenlen = spans.length;
    for (var i = 0; i < lenlen; i++) {
      spans[i].style.color = "#EEE";
    }

    var as = document.getElementsByTagName("A");
    var lenlen2 = as.length;
    for (var j = 0; j < lenlen2; j++) {
      as[j].style.color = "#0aaabf";
    }

    var divs = document.getElementsByTagName("DIV");
    var lenlen3 = divs.length;
    for (var k = 0; k < lenlen3; k++) {
      divs[k].style.color = "#EEE";
    }

    var jjs = document.getElementsByClassName("jj_menu_item");
    var lenlen4 = jjs.length;
    for (var l = 0; l < lenlen4; l++) {
      jjs[l].style.backgroundColor = "#333";
    }

    document.getElementById("gamePanesFinished").style.color = "#EEE";
